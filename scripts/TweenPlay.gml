#define TweenPlay
/// TweenPlay(tween[,prop,ease,mode,delta,delay,dur,start,dest,...])
/*
...
#define TweenPlayTarget
/// TweenPlayTarget(target,deactivated)
/*
...
#define TweenPlayGroup
/// TweenPlayGroup(group,deactivated)
/*
    @group       = tween group
    @deactivated = affect tweens with deactivated targets?
    ...
    INFO:
        Plays tweens associated with specfied tween group.
        All relevant tweens must be fully defined.
*/

TweensExecute(TWEENS_GROUP, argument0, argument1, TweenPlay);

#define TweenPlayDelay
/// TweenPlayDelay(tween,delay)
